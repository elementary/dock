...
namespace Plank
{
	...
	public class ApplicationDockItem : DockItem
	{
		...
		SwitcherooControl switcheroo_control;
		...
		public override Gee.ArrayList<Gtk.MenuItem> get_menu_items ()
		{
			...
			if (!is_running () && switcheroo_control != null && switcheroo_control.has_dual_gpu) {

				print("launcher: %s\n", Prefs.Launcher);

				var app_info = new DesktopAppInfo.from_filename(Filename.from_uri (Prefs.Launcher));
